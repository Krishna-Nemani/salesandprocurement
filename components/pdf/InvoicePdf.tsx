...
export const InvoicePdfDocument: React.FC<{ invoice: InvoiceData }> = ({
  invoice,
}) => {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.headerRow}>
            {invoice.companyLogoUrl && (
              <Image src={invoice.companyLogoUrl} style={styles.logo} />
            )}
            {invoice.companyName && (
        ...
        {/* Seller Details, Bill To, Ship To */}
        <View style={styles.section}>
          <View style={styles.threeColumn}>
            <View style={styles.column}>
              <Text style={styles.sectionTitle}>Seller Details</Text>
              <Text style={styles.label}>Name</Text>
              <Text style={styles.value}>{invoice.sellerCompanyName}</Text>
              ...
              {invoice.sellerEmail && (
                <>
                  ...
                  <Text style={styles.value}>{invoice.sellerEmail}</Text>
                </>
              )}
              {invoice.sellerPhone && (
                <>
                  <Text style={styles.label}>Phone</Text>
                  <Text style={styles.value}>{invoice.sellerPhone}</Text>
                </>
              )}
            ...
            <View style={styles.column}>
              ...
              <Text style={styles.label}>Name</Text>
              <Text style={styles.value}>{invoice.buyerCompanyName}</Text>
              ...
              {invoice.buyerEmail && (
                <>
                  <Text style={styles.label}>Email</Text>
                  <Text style={styles.value}>{invoice.buyerEmail}</Text>
                </>
              )}
              {invoice.buyerPhone && (
                <>
                  <Text style={styles.label}>Phone</Text>
                  <Text style={styles.value}>{invoice.buyerPhone}</Text>
                </>
              )}
            ...
            <View style={styles.columnLast}>
              ...
              {invoice.shipToEmail && (
                <>
                  <Text style={styles.label}>Email</Text>
                  <Text style={styles.value}>{invoice.shipToEmail}</Text>
                </>
              )}
              {invoice.shipToPhone && (
                <>
                  <Text style={styles.label}>Phone</Text>
                  <Text style={styles.value}>{invoice.shipToPhone}</Text>
                </>
              )}
              {invoice.shipToAddress && (
                <>
                  <Text style={styles.label}>Address</Text>
                  <Text style={styles.value}>{invoice.shipToAddress}</Text>
                </>
              )}
            </View>
          </View>
        ...
        <View style={styles.section}>
          ...
          <View style={{ flexDirection: "row", gap: 20 }}>
            ...
            <View>
              ...
              <Text style={styles.value}>{invoice.poId}</Text>
            </View>
            <View>
          ...
          <View style={styles.summaryBox}>
            <View style={styles.summaryRow}>
              ...
              <Text style={styles.summaryValue}>
                {formatCurrency(invoice.sumOfSubTotal, "USD")}
              </Text>
            </View>
            ...
            {invoice.paidAmount !== null && invoice.paidAmount > 0 && (
              <View style={styles.summaryRow}>
                ...
                <Text style={styles.summaryValue}>
                  {formatCurrency(invoice.paidAmount, "USD")}
                </Text>
              </View>
            )}
            {invoice.remainingAmount !== null &&
              invoice.remainingAmount > 0 && (
                <View style={styles.summaryRow}>
                  ...
                  <Text style={styles.summaryValue}>
                    {formatCurrency(invoice.remainingAmount, "USD")}
                  </Text>
                </View>
              )}
          </View>
        ...
        <View style={styles.signatureSection}>
          ...
          {invoice.signatureByName && (
            <View style={styles.signatureRow}>
              ...
              <Text style={styles.value}>{invoice.signatureByName}</Text>
            </View>
          )}
          <View style={styles.signatureRow}>
            <Text style={styles.label}>Acknowledgement (Signature)</Text>
            {invoice.signatureUrl ? (
              <Image src={invoice.signatureUrl} style={styles.signatureImage} />
            ) : (
              <View
                style={[
