...
import { SellerPackingListViewPage } from "@/components/seller/packing-list-view-page";

export default async function SellerPackingListPage({
  params,
}: {
  params: { id: string };
}) {
  ...
  return <SellerPackingListViewPage packingList={serializedPL as any} />;
}
